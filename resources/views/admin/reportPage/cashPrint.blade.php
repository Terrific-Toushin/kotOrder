            ...
            <div class="row">
                <div class="portlet box yellow">
                    ...
                    <div class="portlet-body">
                        <table class="table table-hover table-striped table-bordered" id="sample_cashPrint">
                            <thead>
...
{{--    TableAdvanced.init();--}}
    ...
    window.filterData = function() {
        ...
        axios.post('{{ route('filterCashPrint') }}', {
        ...
        .then(function (response) {
            ...
            const tableBody = document.querySelector('#sample_cashPrint tbody');
